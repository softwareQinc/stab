#ifndef STAB_QASM_HPP_
#define STAB_QASM_HPP_
...
class QASMSimulator final : public ast::Visitor {
  ...
  public:
    explicit QASMSimulator(int nq)
        : psi(nq), temp_value(0), num_qubits(0), num_cbits(0) {}
    ...
    void visit(ast::DeclaredGate& dgate) override { // TODO: Optimize?
        ...
        if (dgate.name() == "h") {
            ...
            throw std::logic_error(
                "Gate must be one of {x, y, z, h, s, sdg, cx, cz, swap}.");
        }
        return;
    }
